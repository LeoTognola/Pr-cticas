# Resultados de las Integrales en Bucle. 
# Según la cantidad de muestras serán los resultados correpondientes a cada integral, variando los limites de integración
# Resultado;error; j=función a la que se refiere
