...
resultados_errores = np.zeros((cantidad_muestras*5, 3))  # Matriz de ceros con filas igual al número de límites y dos columnas (resultado, error)
...
for j in range (5) :   
    for i in range(cantidad_muestras-1):
        ...
        resultados_errores[(j*5)+i] = [resultado, error,j]
